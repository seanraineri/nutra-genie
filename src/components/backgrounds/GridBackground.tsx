  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-gradient-to-b from-cyan-950 to-slate-950">
      ...
      <div className="absolute inset-0" style={{ perspective: '1000px', transformStyle: 'preserve-3d' }}>
        ...
        <div 
          className="absolute inset-0 bg-[linear-gradient(0deg,transparent_47%,rgba(14,165,233,0.03)_48%,rgba(14,165,233,0.08)_50%,rgba(14,165,233,0.03)_52%,transparent_53%)] bg-[length:100%_4rem] animate-[pulse_4s_ease-in-out_infinite]"
          style={{ transform: 'rotateX(60deg) translateZ(-100px)' }}
        />
        
        {/* Vertical grid lines with intersection highlights */}
        <div 
          className="absolute inset-0 bg-[linear-gradient(90deg,transparent_47%,rgba(14,165,233,0.03)_48%,rgba(14,165,233,0.08)_50%,rgba(14,165,233,0.03)_52%,transparent_53%)] bg-[length:4rem_100%] animate-[pulse_4s_ease-in-out_infinite]"
          style={{ transform: 'rotateX(60deg) translateZ(-100px)' }}
        />
        
        {/* Grid intersections glow effect */}
        <div 
          className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(14,165,233,0.15)_0.5px,transparent_1.5px)] bg-[size:4rem_4rem] animate-[pulse_4s_ease-in-out_infinite]"
          style={{ transform: 'rotateX(60deg) translateZ(-100px)' }}
        />
      </div>
